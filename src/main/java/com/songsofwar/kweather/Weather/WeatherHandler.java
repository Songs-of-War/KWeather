...
import com.songsofwar.kweather.WorldGuardManager;
...
public class WeatherHandler 
{
	...
	private WeatherHandler(FileConfiguration config)
	{
		...
		}.runTaskTimer(KWeather.getPlugin(), WeatherHandler.getWeatherInterval(), WeatherHandler.getWeatherInterval());
	}
	...
	public static void stopAll()
	{
		...
		}.runTaskLater(KWeather.getPlugin(), 20);
	}
