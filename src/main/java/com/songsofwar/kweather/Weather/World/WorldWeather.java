...
import com.songsofwar.kweather.Weather.Wind;
import com.songsofwar.kweather.Weather.World.Types.AcidRain;
import com.songsofwar.kweather.Weather.World.Types.CatsAndDogs;
import com.songsofwar.kweather.Weather.World.Types.EarthQuake;
import com.songsofwar.kweather.Weather.World.Types.FlashFlood;
import com.songsofwar.kweather.Weather.World.Types.HailStorm;
import com.songsofwar.kweather.Weather.World.Types.HeavyRain;
import com.songsofwar.kweather.Weather.World.Types.MeteorShower;
import com.songsofwar.kweather.Weather.World.Types.SandStorm;
import com.songsofwar.kweather.Weather.World.Types.ShootingStars;
import com.songsofwar.kweather.Weather.World.Types.SnowStorm;
import com.songsofwar.kweather.Weather.World.Types.SunShower;
import com.songsofwar.kweather.Weather.World.Types.ThunderStorm;
import com.songsofwar.kweather.Weather.World.Types.Windy;
...
public class WorldWeather implements WorldWeatherType
{
	...
	{
		name = KWeather.getLanguageLoader().getLanguage().getString("WeatherTypes." + configprefix);
	}
	...
	public void start(int dur, World world)
	{
		...
		String[] vars = {"<world>", 
				(world == null)?KWeather.getLanguageLoader().getLanguage().getString("ChatMessages.allworlds"):world.getName()};
		...
		if(args[1].equalsIgnoreCase(name)) {
			if(args.length == 2) {
				...
				if(sender instanceof Player) {
					String[] vars = {"<world>", 
							KWeather.getLanguageLoader().getLanguage().getString("ChatMessages.allworlds")};
