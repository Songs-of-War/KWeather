...
import com.songsofwar.kweather.Weather.ArmourStandMaker;
...
public class Meteor 
{
	...
	public Meteor(Location location, float explosionsize, boolean firemeteor)
	{
		...
		}.runTaskTimer(KWeather.getPlugin(), 0, 1);
	}
	...
	{
		if(args[1].equalsIgnoreCase(KWeather.getLanguageLoader().getLanguage().getString("WeatherTypes.Meteor"))) {
			Player p = null;
			Location l = null;
