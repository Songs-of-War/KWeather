package com.songsofwar.xweather.xweather.Weather.World;
...
import com.songsofwar.xweather.xweather.Commands;
import com.songsofwar.xweather.xweather.LanguageLoader;
import com.songsofwar.xweather.xweather.XWeather;
import com.songsofwar.xweather.xweather.Weather.WeatherHandler;
import com.songsofwar.xweather.xweather.Weather.Wind;
import com.songsofwar.xweather.xweather.Weather.World.Types.AcidRain;
import com.songsofwar.xweather.xweather.Weather.World.Types.CatsAndDogs;
import com.songsofwar.xweather.xweather.Weather.World.Types.EarthQuake;
import com.songsofwar.xweather.xweather.Weather.World.Types.FlashFlood;
import com.songsofwar.xweather.xweather.Weather.World.Types.HailStorm;
import com.songsofwar.xweather.xweather.Weather.World.Types.HeavyRain;
import com.songsofwar.xweather.xweather.Weather.World.Types.MeteorShower;
import com.songsofwar.xweather.xweather.Weather.World.Types.SandStorm;
import com.songsofwar.xweather.xweather.Weather.World.Types.ShootingStars;
import com.songsofwar.xweather.xweather.Weather.World.Types.SnowStorm;
import com.songsofwar.xweather.xweather.Weather.World.Types.SunShower;
import com.songsofwar.xweather.xweather.Weather.World.Types.ThunderStorm;
import com.songsofwar.xweather.xweather.Weather.World.Types.Windy;
...
public class WorldWeather implements WorldWeatherType
{
	...
	{
		name = XWeather.getLanguageLoader().getLanguage().getString("WeatherTypes." + configprefix);
	}
	...
	public void start(int dur, World world)
	{
		...
		String[] vars = {"<world>", 
				(world == null)?XWeather.getLanguageLoader().getLanguage().getString("ChatMessages.allworlds"):world.getName()};
		...
		}.runTaskTimer(XWeather.getPlugin(), 0, tickrate);
	}
		...
		if(args[1].equalsIgnoreCase(name)) {
			if(args.length == 2) {
				...
				if(sender instanceof Player) {
					String[] vars = {"<world>", 
							XWeather.getLanguageLoader().getLanguage().getString("ChatMessages.allworlds")};
	...
	public static boolean checkCommands(CommandSender sender, String[] args)
	{
		for(WorldWeatherType weather : weathertypes) {
			if(args[0].equalsIgnoreCase(XWeather.getLanguageLoader().getLanguage().getString("ChatCommands.set"))) {
				if(args.length == 1) {
			...
			} else if(args[0].equalsIgnoreCase(XWeather.getLanguageLoader().getLanguage().getString("ChatCommands.stop"))) {
