...
import com.songsofwar.xweather.xweather.Weather.ArmourStandMaker;
...
public class Meteor 
{
	...
	public Meteor(Location location, float explosionsize, boolean firemeteor)
	{
		...
		}.runTaskTimer(XWeather.getPlugin(), 0, 1);
	}
	...
	{
		if(args[1].equalsIgnoreCase(XWeather.getLanguageLoader().getLanguage().getString("WeatherTypes.Meteor"))) {
			Player p = null;
			Location l = null;
