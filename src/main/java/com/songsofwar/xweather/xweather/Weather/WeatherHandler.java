...
import com.songsofwar.xweather.xweather.WorldGuardManager;
...
public class WeatherHandler 
{
	...
	private WeatherHandler(FileConfiguration config)
	{
		...
		}.runTaskTimer(XWeather.getPlugin(), WeatherHandler.getWeatherInterval(), WeatherHandler.getWeatherInterval());
	}
	...
	public static void stopAll()
	{
		...
		}.runTaskLater(XWeather.getPlugin(), 20);
	}
